              ...
              <tr key={e.id}>
                ...
                <td>
                  <div className="btn-group mb-3">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#editVisitor">
                      <button className="btn btn-outline-secondary" type="button" value={e} onClick={()=> { showModal(e) }}>
